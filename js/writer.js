...
class NewsWriter {
  ...
  generateShortContent(news, style) {
    const templates = {
      ...
      review: [
        ...
        `【简评】${news.title}\n\n${news.summary}\n\n产品力解读：这次改款/上市可以说诚意满满。亮点突出，短板也有改善。推荐指数：⭐⭐⭐⭐`
      ],
      push: [
      ...
      news: [
        ...
        `汽车圈又有新动静！${news.title}\n\n${news.summary}\n\n业内人士分析认为，${news.source}的相关布局将对行业格局产生一定影响。更多详情，我们将持续关注。`,

        `今日车闻：${news.title}\n\n${news.summary}\n\n截至发稿时，官方尚未公布更多详细信息。关注我们，第一时间获取最新资讯。`
      ]
    };
  ...
  generateLongContent(news, style) {
    const templates = {
      ...
      review: [
        `【深度解析】${news.title}\n\n一、事件背景\n\n今日，汽车行业迎来重要消息：${news.title}。${news.summary}\n\n二、产品/技术分析\n\n1. 动力系统\n本次更新在动力方面的提升较为明显。采用了最新的技术路线，在保证动力输出的同时，进一步优化了燃油经济性/续航表现。\n\n2. 智能配置\n智能化是当下汽车发展的重要方向。本次更新在智能座舱、智能驾驶方面都有所升级。具体表现在：\n- 芯片算力提升\n- 传感器数量增加\n- 软件算法优化\n\n3. 空间舒适性\n作为家用车，空间表现至关重要。新车在轴距/车身尺寸上有所提升，实际乘坐体验需要实车验证。\n\n三、市场影响分析\n\n从市场角度来看，${news.title}的推出，将对同级别竞品形成一定压力。尤其是在${news.source}细分市场，可能引发新一轮竞争。\n\n四、购买建议\n\n对于近期有购车计划的朋友，建议：\n1. 保持关注，等待详细评测\n2. 试驾体验，感受实际表现\n3. 对比竞品，综合考虑性价比\n\n本文将持续关注该车型的后续报道。`,

        `【汽车观察】${news.title}\n\n行业动态\n\n今日，${news.source}正式发布了${news.title}的相关信息。${news.summary}\n\n深度解读\n\n从行业角度分析，此次发布有以下几个看点：\n\n首先是技术层面。新品在核心技术上有所突破，体现了品牌的研发实力。无论是动力电池、电机电控，还是智能驾驶，都达到了同级别主流水平。\n\n其次是市场定位。产品的定价策略和配置组合，明显是奔着走量去的。这也将对同级别其他品牌形成直接竞争。\n\n第三是渠道布局。从发布节奏来看，品牌已经做好了充分的市场准备。\n\n竞品对比\n\n从目前掌握的信息来看，新车的直接竞品主要包括：\n- 竞品A：优势在于品牌认知度\n- 竞品B：优势在于性价比\n- 竞品C：优势在于技术领先\n\n综合来看，这款产品有其独特的竞争力。是否值得购买，建议等详细评测出来后再做判断。\n\n结语\n\n汽车市场的竞争日趋激烈，消费者的选择也越来越多。对于普通消费者来说，适合自己的才是最好的。建议大家在选车时，充分考虑自身需求，多对比、多试驾。`
      ],
      push: [
        `❤️ 强烈推荐！${news.title}\n\n家人们！今天必须给大家安利一波！\n\n你们要的真的来了！${news.title}！\n\n讲真，当我第一眼看到这个的时候，我就知道——这波稳了！\n\n先说说这个${news.summary}\n\n相信我，这绝对是一款值得关注的产品！为什么这么说？\n\n✅ 亮点一：颜值能打\n✅ 亮点二：配置丰富\n✅ 亮点三：价格美丽\n\n而且最重要的是，现在入手真的是最佳时机！\n\n我已经帮你们试过了，确实香！想了解的宝子们，评论区扣"1"，我来安排！\n\n数量有限，先到先得！冲鸭！🎉\n\n#汽车 #新车 #种草`,

        `✨爆款预警！${news.title}\n\n姐妹们！兄弟们！今天必须分享一个超级重磅的消息！\n\n${news.title}来了！\n\n真的！看完这个我整个人都激动了！${news.summary}\n\n说真的，这绝对是我今年见过最香的产品之一！\n\n你们看看这配置：\n👍 外观：颜值即正义\n👍 性能：动力充沛\n👍 性价比：同级最香\n\n而且现在正值活动期间，福利多多！\n\n我已经帮你们问过了，现在入手绝对不亏！\n\n感兴趣的宝子们，麻溜的！名额有限，手慢无！\n\n评论区扣"1"，我来给你安排！🚀`
      ],
      news: [
        `【汽车之家】${news.title}\n\n[新闻背景]\n\n今日，${news.source}正式对外发布了${news.title}的相关信息。${news.summary}\n\n[详细报道]\n\n据官方介绍，本次发布的车型/技术具有以下特点：\n\n一、产品亮点\n1. 采用最新的设计语言，外观更具辨识度\n2. 动力系统全面升级，性能表现更出色\n3. 智能配置丰富，智能化程度更高\n\n二、市场定位\n该车型主要面向追求品质生活的消费群体，定价策略兼顾性价比。\n\n三、未来规划\n\n官方表示，将持续深耕中国市场，为消费者带来更多优质产品。\n\n[记者观察]\n\n作为汽车行业的重要事件，${news.title}的发布引起了业内广泛关注。有分析认为，这将推动${news.source}细分市场的竞争格局发生变化。\n\n[后续报道]\n\n我们将持续关注该车型的最新进展，并为您带来更多详细报道。`,

        `【行业快讯】${news.title}\n\n今日，${news.source}正式宣布：${news.title}。这是${news.source}今年在汽车市场的又一重要布局。\n\n${news.summary}\n\n[深度分析]\n\n1. 市场影响\n该产品的推出，将进一步完善${news.source}的产品矩阵，增强在${news.source}细分市场的竞争力。\n\n2. 技术亮点\n新产品在动力、智能化、空间等方面都有明显升级，体现了品牌的技术实力。\n\n3. 竞争格局\n随着新品的加入，${news.source}细分市场的竞争将更加激烈。\n\n[结语]\n\n总的来看，${news.title}是一款值得关注的产品。具体市场表现如何，还需等待时间检验。\n\n汽车之家将持续关注报道。`
      ]
    };
